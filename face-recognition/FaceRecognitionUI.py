...
access = ' '
path = '/Users/naukadhabalia/git/library-management/face-recognition/ImagesAttandenceProject'
images = []
classNames = []
...
attendance_csv = '/Users/naukadhabalia/git/library-management/face-recognition/Attendance' + today.strftime(
    "%m_%d_%y") + '.csv'
